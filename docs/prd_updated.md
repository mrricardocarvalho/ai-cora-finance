...
**Author:** Ricar
**Date:** 2025-11-28
**Version:** 1.1 (Corrected & Complete)
...
| Category | Features |
|----------|----------|
| **Data & Accounts** | Bank statement PDF import with AI parsing, smart auto-categorization, **Bulk Edit Capabilities**, multi-account dashboard |
| **Conversational Interface** | Natural language chat, rich responses (graphs, lists, tables), **Insight Feed Engine** |
| **Onboarding** | Conversational onboarding interview, comfort floor setup, goals & worries capture, risk tolerance assessment |
| **Insights** | **Safe-to-Spend Metric**, Spending dashboard, financial health score (0-100) |
...
- **FR16.1 (Bulk Edit):** Users can select multiple transactions and apply category changes or deletions in batch.
...
### Conversational Interface & Insight Feed
...
- **FR28 (Insight Engine):** System generates discrete "Insight Objects" based on data analysis.
- **FR28.1 (Prioritization):** System ranks insights by urgency (Urgent > Important > Opportunity > Info) to populate the Insight Feed.
...
### Spending Insights & Safe-to-Spend
...
- **FR39.1 (Safe-to-Spend):** System calculates and displays "Safe-to-Spend" amount: `Current Available Balance - Comfort Floor - Pending Recurring Bills for Period`.
...
| **Privacy Visibility (FR73)** | System must expose encryption status to the frontend (e.g., "Data Encrypted" signal) to reassure users during sensitive operations. |
...
_Updated: 2025-11-28 to incorporate UX Design phase discoveries (Insight Feed, Safe-to-Spend, Bulk Edit, Privacy) and restored critical domain requirements._
